package com.beacmc.beacmcstaffwork.command.admin.tabcompleter;
...
public class StaffAdminCompleter implements TabCompleter {
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, @NotNull String[] args) {
        ...
        if(args.length == 2) {
            if(args[0].equalsIgnoreCase("reset")
                    ...
                    || args[0].equalsIgnoreCase("deleteuser")) {
        ...
        if(args.length == 3) {
            ...
            return getCompletionsTwoArgs().stream().filter((category) -> {
    ...
    private static List<String> getCompletionsOneArgs() {
        return List.of("reload", "reset", "stats", "deleteuser");
    }

    private static List<String> getCompletionsTwoArgs() {
        return List.of("all", "bans", "time", "kicks", "mutes", "unmutes", "unbans");
    }
}
